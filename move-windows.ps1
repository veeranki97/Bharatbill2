# SD Dynamics - Windows "Move to Another PC" export.
#
...
# SD Dynamics there (fresh HTA launcher install), then uses
# Restore Backup to pull their invoices in.

$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'SD Dynamics - Move to Another PC'
...
$out = Join-Path $desktop "MOVE-SDDynamics-$stamp.zip"
...
Write-Host '    1. Install SD Dynamics on the new PC (double-click the HTA launcher there).'

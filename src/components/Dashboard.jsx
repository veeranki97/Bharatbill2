...
<div className="stats-grid stats-grid-4">
      ...
      {!listMode && (
        <div className="glass-panel" style={{ marginBottom: "1.25rem", padding: "1rem 1.25rem" }}>
          <h3 style={{ margin: "0 0 0.75rem", fontSize: "0.95rem" }}>At-risk accounts (overdue)</h3>
          {overdueBills.slice(0, 8).map(b => (
            <div key={b.id} style={{ display: "flex", justifyContent: "space-between", fontSize: "0.85rem", marginBottom: 4 }}>
              <span><strong>{b.clientName}</strong> · {b.invoiceNumber}</span>
              <span style={{ color: "#dc2626" }}>{formatCurrency((b.totalAmount||0)-(b.paidAmount||0), b.currency)}</span>
            </div>
          ))}
          {overdueBills.length === 0 && <span style={{ color: "#94a3b8" }}>No overdue invoices</span>}
...
<div className="glass-panel invoice-list-panel" data-testid="invoice-list">
        ...
        <div className="filters-bar">
          <div className="search-box">
            ...
            <input type="text" placeholder="Search client or invoice..." data-list-anchor="1" value={search}
